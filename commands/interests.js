module.exports = {
    ...
    execute (message, args) {
        ...
        const interestGroupsEmbed = new Discord.MessageEmbed()
            ...
            .addField(':computer: Development', 'It\'s no surprise d.tech has its fair share of devs. The programming world can be toxic to newcomers, so whether you\'re just getting into it, or well on your way, come join and see what the community is up to!', true)
            //.addField(':art: Design', 'stuff also goes here', true)
            .addField(':gear: Productivity', 'Yep, d.tech has productivity nerds too. Want to learn more and discuss apps and tools like Todoist, Notion, etc.? This is the place for you!', true)
